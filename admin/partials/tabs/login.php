        ...
        <div class="card mb-0">
            <div class="card-body">
                <a href="javascript:void(0);" class="brand-logo">
                    <svg class="jt-woocommerce-logo" fill="#ED3237" xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="200px" height="49" version="1.1" style="shape-rendering:geometricPrecision; text-rendering:geometricPrecision; image-rendering:optimizeQuality; fill-rule:evenodd; clip-rule:evenodd" viewBox="0 0 14081 3067" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <g id="Layer_x0020_1">
                ...
                <h4 class="card-title mb-1">Welcome to J&T Express 👋</h4>
                <p class="card-text mb-2">Add J&T Epxress for WooCommerce to track J&T orders, mapping service, create
                    order...</p>
                <div id="connectMessage" class="alert mt-2" role="alert" style="display: none;">
                    <div class="alert-body"></div>
                </div>
                <form class="auth-login-form mt-2" novalidate="novalidate">
                    <div class="form-group">
                        <label for="jt-auth-username" class="form-label">Email</label>
                        <input type="text" class="form-control" id="jt-auth-username" name="jt-auth-username" autocomplete='off'
                            placeholder="john@example.com" aria-describedby="jt-auth-username" tabindex="1" autofocus />
                    </div>

                    <div class="form-group">
                        <div class="d-flex justify-content-between">
                            <label for="jt-auth-password">Password</label>
                            <a href="#">
                                <small>Forgot Password?</small>
                            </a>
                        </div>
                        <div class="input-group input-group-merge form-password-toggle">
                            <input type="password" class="form-control form-control-merge" id="jt-auth-password" autocomplete='off'
                                name="jt-auth-password" tabindex="2"
                                placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
                    ...
                    <button class="btn btn-primary btn-block mt-2">
                        ...
                        <span class="align-middle">Connect</span>
                    </button>
                    <p class="text-center mt-2">
                        <span>New on our platform?</span>
                        <a id="btn-create-new-merchant" data-toggle="modal" data-target="#create-new-merchant-modal" href="#">
...
<?php include_once 'login/create-account-modal.php'; ?>